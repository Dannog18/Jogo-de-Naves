...
var TECLA = {
    ...
    // var somGameOver2=document.getElementById("somGameOver2");
...
/* Obs. extra: atalhos pra ajudar na programação: ctrl + shift + i ( abre o console da página 
    web que estiver trabalhando, muito bom para verificação de erros);
Ctrl + Shift + L ( Seleciona todas as tags IGUAIS em valor ao mesmo tempo para editar);
Já para pesquisar uma palavra no código é só digitar "Ctrl+F" */
